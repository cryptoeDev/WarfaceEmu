...
namespace EmuWarface.Core
{
    public static class SQL
    {
        ...
        public static readonly string constr = $"server={EmuConfig.Sql.Server};user id={EmuConfig.Sql.User};password={EmuConfig.Sql.Password};database={EmuConfig.Sql.Database};characterset={EmuConfig.Sql.CharacterSet};port={EmuConfig.Sql.Port};convertzerodatetime=True";
